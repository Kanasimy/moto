...
if (count($arResult["OFFERS"]) > 0) {
    foreach ($arResult["OFFERS"] as $offer) :?>        <div class="offers-btn-wrap" style="display: none" data-item="<?=$offer["ID"]?>">
	...
	<?endif;
      ...
      class="TINKOFF_BTN_YELLOW"
			onclick="tinkoff.create({
				sum: '<?=$arResult["CATALOG_PRICE_1"]?>',
        shopId: '36aa70ed-46b2-44fd-970f-583dd51e7eeb',
        showcaseId: 'bb2f93a6-56e4-4bbd-9f54-ffe9af9310d2',
        demoFlow: 'sms',
        items: [
          {name: '<?= $arResult["NAME"]?>', price: '<?=$arResult["CATALOG_PRICE_1"]?>', quantity: 1},
