		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<?=$this->GetEditAreaId($arSection['ID']);?>">
                    ...
                    <div class="vikz_block">
                        <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="bx_catalog_tile_img">
                            <?php $vikz = $arSection['PICTURE']['SRC']; ?>
                            <?php if(!empty($vikz)){ ?>
                            <img src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="<? echo $arSection['PICTURE']['TITLE']; ?>" class="alignleft vikz_block_img">
                            <?php } else { ?>
                            <img src="/images/zagl.jpg" alt="#" class="alignleft vikz_block_img">
                            <?php } ?>
                        </a>
                        <div class="vikz_block_text">
                            <? //echo $arSection['DESCRIPTION']; ?>


                            <? $db_list = CIBlockSection::GetList(Array($by=>$order), $arFilter = Array("IBLOCK_ID"=>$arSection["IBLOCK_ID"], "ID"=>$arSection["ID"]), true,$arSelect=Array("UF_DESC_VIKZ"));

                            while($ar_result = $db_list->GetNext()): ?>

                                <? //if ($ar_result["UF_DESC_VIKZ"]):?>
                                <? echo $ar_result["UF_DESC_VIKZ"]; ?>
