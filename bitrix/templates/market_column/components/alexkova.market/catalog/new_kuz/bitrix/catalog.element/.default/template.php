...
<div class="row">
	...
	<?        
        ...
        //--basket-btns block--
	?>
        <div id="bxr-market-detail-basket-btn-wrap dsdsdsds">
        ...
        if ($arResult["PreviewBlockShow"]) {?>
			...
			<!-- Добавленно для наличие товара-->
				<p><strong>Наличие товаров в розничной сети Байкер пожалуйста уточняйте по телефону соответствующего магазина, указанному в разделе</strong> <a href="/company/contacts/">«Контакты»</a>.<p>
                <!--конец добавления о наличие товара-->
