...
<div class="vikz col-sm-12 hidden-xs">
    <h2>Основные категории товаров: интернет-магазин бензопил, мототехники, мотоциклов, мопедов и средств передвжиения</h2>
    <p>Предлагаем ознакомиться с нашим обширным каталогом. Для вас в наличии самые популярная мототехника, средства передвижения а также бензо- и электроинструменты, лодочные моторы, аксессуары и необходимые запчасти.</p>
    <p style="text-align: center;"><strong>Что вы получите, заказывая в магазине Moto36?</strong></p>
    <ul>
        <li>Транспортные средства и техника высочайшего качества.</li>
        <li>Соответствие выбранной техники вашим ожиданиям: вы точное знаете, ЧТО получите, заказывая у нас.</li>
        <li>В наличии большой выбор запчастей, аксессуаров для мотоциклов и средств передвжиения от официальных производителей.</li>
        <li>Выгодные и оптимальные условия доставки, все варианты оплаты: перевод на карту, наличный и безналичный расчет.</li>
    </ul>
</div>
